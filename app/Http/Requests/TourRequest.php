...
class TourRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'available_time' => 'bail|required|json',
    ...
    public function messages(): array
    {
        return [
            ...
            'available_time.required' => __('messages.tour-available-time-required'),
            'available_time.json' => __('messages.tour-available-time-json'),
