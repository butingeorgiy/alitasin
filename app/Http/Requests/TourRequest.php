...
class TourRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ua_title' => 'bail|required|string|min:10|max:256',
            ...
            'ua_description' => 'bail|required|string|min:10|max:10240',
    ...
    public function messages(): array
    {
        return [
            ...
            'ua_title.required' => __('messages.tour-ua-title-required'),
            'ua_title.min' => __('messages.tour-ua-title-min'),
            'ua_title.max' => __('messages.tour-ua-title-max'),
            ...
            'ua_description.required' => __('messages.tour-ua-description-required'),
            'ua_description.min' => __('messages.tour-ua-description-min'),
            'ua_description.max' => __('messages.tour-ua-description-max'),
