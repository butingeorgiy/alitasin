<section class="mb-10 border-b border-gray-200">
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-4 mx-auto px-5 pt-2 pb-6">
        ...
        <a href="{{ route('property') }}" class="flex flex-col px-8 pt-8 pb-4 text-white bg-center bg-cover bg-no-repeat rounded-md"
            ...
            <p class="mt-auto font-semibold">{{ App\Models\Property::count() }} {{ __('short-phrases.main-sections-property-amount') }}</p>
        </a>
