            ...
            <div class="mb-4">
                ...
                <div class="flex">
                    <div class="flex mr-5 px-3 py-2 border border-gray-500 rounded-md" style="min-width: 300px; width: 300px">
                        <input type="text" name="search" placeholder="{{ __('short-phrases.search') }}" class="w-full text-sm text-gray-500 placeholder-gray-500">
                    ...
                    @if(\App\Facades\Auth::check(['5']))
                        <a href="{{ route('create-form-tour') }}" class="flex justify-center items-center px-8 py-2 text-sm text-white font-medium rounded-md bg-green">
                            ...
                            <span>{{ __('buttons.add-excursion') }}</span>
                        </a>
                    @endif
                </div>
            </div>
