...
<div class="reserves-item grid grid-cols-reserve-table gap-5 px-8 py-4 border-b border-gray-200">
    <div class="flex">
        <div class="min-w-11 min-h-11 w-11 h-11 mr-6 bg-contain bg-center bg-no-repeat bg-blue rounded-full"></div>
        <div class="flex flex-col justify-center">
            <p class="text-black font-semibold">{{ $reservation->user->full_name }}</p>
            <p class="text-sm text-gray-600 font-light">{{ $reservation->user->email }}</p>
        </div>
    </div>
    ...
    <div class="flex flex-col">
        <p class="text-black font-semibold">{{ $reservation->createAtDate() }}</p>
        <p class="text-sm text-gray-600 font-light">{{ $reservation->createAtTime() }}</p>
    </div>
    <div class="relative flex items-center">
        ...
        @elseif($reservation->status->id === 3)
            <div class="flex justify-center w-14 py-1.5 text-sm text-white bg-red-100 rounded-full" title="{{ $reservation->status[App::getLocale() . '_name'] }}">
