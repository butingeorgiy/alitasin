...
return [
    ...
    'sub-partner-profit-percent' => 'Процент прибыли от под партнёра',
    'income' => 'Доход',
    'earned' => 'Заработано',
    'payed' => 'Оплачено',
    'status' => 'Статус',
    ...
    'vehicle-region-warning' => 'Не все транспортные средства доступны во всех регионах, поэтому сначала выберите регион вашего местонахождения!',
    'any' => 'Любой',
