<div id="regPopup" class="fixed hidden w-screen h-screen top-0 left-0 flex justify-center items-center z-50 bg-black bg-opacity-60">
    <div class="popup flex flex-col relative top-0 top-80 p-5 sm:p-10 bg-white rounded-xl duration-300">
        <div class="flex items-center mb-8">
            <p class="mr-auto text-2xl text-black font-bold tracking-wider"><?php echo e(__('short-phrases.registration')); ?></p>
        ...
        <label class="flex items-center mb-4 px-3 py-2 border-2 border-gray-100 bg-gray-100 rounded-md focus-within:bg-white focus-within:border-blue">
            ...
            <span class="flex flex-col w-full">
                <span class="text-sm text-gray-300 tracking-wider"><?php echo e(__('short-phrases.first-name')); ?></span>
        ...
        <label class="flex items-center mb-4 px-3 py-2 border-2 border-gray-100 bg-gray-100 rounded-md focus-within:bg-white focus-within:border-blue">
            ...
            <span class="flex flex-col w-full">
                <span class="text-sm text-gray-300 tracking-wider"><?php echo e(__('short-phrases.phone')); ?></span>
        ...
        <label class="flex items-center mb-4 px-3 py-2 border-2 border-gray-100 bg-gray-100 rounded-md focus-within:bg-white focus-within:border-blue">
            ...
            <span class="flex flex-col w-full">
                <span class="text-sm text-gray-300 tracking-wider"><?php echo e(__('short-phrases.email')); ?></span>
        ...
        <div class="create-account-button flex justify-center items-center py-3 text-sm text-white font-medium bg-blue rounded-md tracking-wider cursor-pointer">
            ...
            <?php echo e(__('buttons.create-account')); ?>

        </div>
    </div>
</div>
<?php /**PATH /Users/butingeorgiy/Workspace/Dev/www-root/alitasin/resources/views/popups/reg.blade.php ENDPATH**/ ?>