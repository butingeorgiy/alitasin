...
<?php if($isMainAdmin): ?>
    <div class="mt-10 -mb-10 border-b border-gray-200">
        <div class="container flex mx-auto px-5 pb-5">
            <a href="<?php echo e(route('edit-transfers')); ?>" class="flex flex items-center mr-16 group">
                <span class="mr-4 inline text-blue text-2xl group-hover:underline"><?php echo e(__('short-phrases.transfers')); ?></span>
            ...
            <a href="<?php echo e(route('partners')); ?>" class="flex flex items-center mr-auto group">
                <span class="mr-4 inline text-blue text-2xl group-hover:underline"><?php echo e(__('short-phrases.partners')); ?></span>
                <svg class="w-3" viewBox="0 0 19 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.875 28.75L16.125 15.5L2.875 2.25" stroke="#0094FF" stroke-width="3"
                          stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            ...
            <a href="<?php echo e(route('create-vehicle')); ?>" class="flex flex items-center mr-16 group">
                <span class="mr-4 inline text-blue text-2xl group-hover:underline"><?php echo e(__('short-phrases.add-vehicle')); ?></span>
                <svg class="w-3" viewBox="0 0 19 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.875 28.75L16.125 15.5L2.875 2.25" stroke="#0094FF" stroke-width="3"
                          stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            ...
            <a href="<?php echo e(route('create-property')); ?>" class="flex flex items-center group">
                <span class="mr-4 inline text-blue text-2xl"><?php echo e(__('short-phrases.add-property')); ?></span>
                <svg class="w-3" viewBox="0 0 19 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.875 28.75L16.125 15.5L2.875 2.25" stroke="#0094FF" stroke-width="3"
                          stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
...
<section id="toursSection" class="mb-10 pb-6 border-b border-gray-200" data-is-admin="<?php echo e(App\Facades\Auth::check(['3', '5']) and request()->is('admin/*') ? '1' : '0'); ?>">
    <div class="container mx-auto px-5 <?php echo e($isAdmin ? 'mt-16' : ''); ?>">
        <?php if(!$isAdmin): ?>
            <div class="flex justify-between items-center lg:justify-center mb-4">
                <p class="inline text-black text-2xl font-bold text-black"><?php echo e(__('short-phrases.all-tours')); ?><span class="text-blue">.</span></p>
                <?php if(count($tours) > 0): ?>
                    <span class="show-filters-button block lg:hidden px-5 py-1 text-sm text-blue border-2 border-blue rounded-md cursor-pointer"><?php echo e(__('short-phrases.filters')); ?></span>
                <?php endif; ?>
            </div>
        <?php else: ?>
            <div class="mb-4">
                ...
                <div class="flex">
                    <div class="flex mr-5 px-3 py-2 border border-gray-500 rounded-md" style="min-width: 300px; width: 300px">
                        <input type="text" name="search" placeholder="<?php echo e(__('short-phrases.search')); ?>" class="w-full text-sm text-gray-500 placeholder-gray-500">
                    ...
                    <?php if(App\Facades\Auth::check(['5'])): ?>
                        <a href="<?php echo e(route('create-form-tour')); ?>" class="flex justify-center items-center px-8 py-2 text-sm text-white font-medium rounded-md bg-green">
                            <svg class="mr-3 h-4 w-4 text-white" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20.3333 9.66671H12.3333V1.66671C12.3333 1.31309 12.1928 0.973947 11.9427 0.723899C11.6927 0.47385 11.3535 0.333374 10.9999
                                         ...
                                         10.6463 21.6667 10.9999 21.6667C11.3535 21.6667 11.6927 21.5262 11.9427 21.2762C12.1928 21.0261 12.3333 20.687 12.3333 20.3334V12.3334H20.3333C20.6869
                                         12.3334 21.026 12.1929 21.2761 11.9428C21.5261 11.6928 21.6666 11.3537 21.6666 11C21.6666 10.6464 21.5261 10.3073 21.2761 10.0572C21.026
                                         9.80718 20.6869 9.66671 20.3333 9.66671Z" fill="white"/>
                            </svg>
                            <span><?php echo e(__('buttons.add-excursion')); ?></span>
                        </a>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="flex items-start relative">
            <div class="left-side hidden lg:block absolute lg:relative right-0 z-10 mr-0 lg:mr-5">
                <div class="filters mb-0 lg:mb-5 bg-white shadow rounded-md">
                    <div class="flex flex-col py-4">
                        <p class="mb-3 px-3 text-xl text-black font-bold"><?php echo e(__('short-phrases.filters')); ?></p>
                        <div class="flex flex-wrap mb-4 px-3 pb-4 gap-2 border-b border-gray-200">
                            <?php $__currentLoopData = \App\Models\Filter::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="filter-item" data-filter-id="<?php echo e($filter->id); ?>">
                                    <span
                                        class="text-blue"><?php echo e($filterCounter[$filter->id] ?? 0); ?></span>&nbsp;&nbsp;<?php echo e($filter->name); ?>
                        ...
                        <p class="mb-3 px-3 text-xl text-black font-bold"><?php echo e(__('short-phrases.price')); ?></p>
                        <div class="flex items-center mb-4 px-3 pb-4 border-b border-gray-200">
                            ...
                            <input type="text" name="price_from"
                                   ...
                                   placeholder="<?php echo e(__('short-phrases.from')); ?>">
                            <div class="w-6 mx-4 border-b-2 border-black"></div>
                            <input type="text" name="price_to"
                                   class="w-20 px-2 py-1 text-sm text-center text-gray-600 placeholder-gray-600 border-2 border-black rounded-full"
                                   placeholder="<?php echo e(__('short-phrases.to')); ?>">
                        </div>
                        ...
                        <p class="mb-3 px-3 text-xl text-black font-bold"><?php echo e(__('short-phrases.tour-types')); ?></p>
                        <div class="flex flex-wrap mb-4 px-3 pb-4 gap-2 border-b border-gray-200">
                            <?php $__currentLoopData = \App\Models\TourType::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    class="type-items inline px-3 py-1 text-sm border-2 border-gray-600 rounded-full cursor-pointer"
                                    data-type-id="<?php echo e($type->id); ?>">
                        ...
                        <button
                            ...
                            disabled><?php echo e(__('buttons.reset-filters')); ?></button>
                    </div>
                </div>
                <div class="hidden lg:block p-3 bg-gray-100 shadow rounded-md">
                    <p class="mb-3 text-black font-semibold leading-5"><?php echo e(__('short-phrases.connect-with-us-title')); ?></p>
            ...
            <div class="tours-container w-full grid sm:grid-cols-2 xl:grid-cols-3 gap-5">
                <?php $__empty_1 = true; $__currentLoopData = $tours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php echo $__env->make('components.tours.tour-card', compact('tour'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <p class="lg:m-3 text-xl text-gray-600 font-light"><?php echo e(__('messages.no-results')); ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="show-more-tours-button mt-6 bg-blue <?php echo e(count($tours) < 15 ? 'disabled' : ''); ?>">
            ...
            <span><?php echo e(__('buttons.show-more')); ?></span>
        </div>
    </div>
</section>
<?php /**PATH /Users/butingeorgiy/Workspace/Dev/www-root/alitasin/resources/views/components/general/tours.blade.php ENDPATH**/ ?>